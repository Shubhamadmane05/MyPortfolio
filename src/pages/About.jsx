      ...
      >
        <div className="container">
          ...
          <div className="row text-white mt-5">
            ...
            {/*Software Developer Intern  INFOSYS LIMITED */}
            <div className="col-md-6 mb-4" data-aos="fade-right">
              <div className="card h-100 bg-transparent border border-secondary text-white">
                <div className="card-body">
                  <h5 className="fw-bold">Software Developer Intern |<span className="text-warning">  INFOSYS LIMITED</span></h5>
                  <p className="mb-1"><strong>Aug '25 — Present </strong>| Internship | Chennai, India</p>
                  {/* <ul className="ps-3">
            ...
            <div className="col-md-6 mb-4" data-aos="fade-right">
              <div className="card h-100 bg-transparent border border-secondary text-white">
                <div className="card-body">
                  <h5 className="fw-bold">Full Stack Developer Intern |<span className="text-warning"> Unified mentor Private Ltd</span></h5>
                  <p className="mb-1"><strong>July '25 — Present </strong>| Part-Time | Remote</p>
                  {/* <ul className="ps-3">
                  <li>Designed and implemented RESTful APIs using Java and Spring Boot.</li>
                  <li>Spearheaded React.js UI development, improving load time by 20%.</li>
                  <li>Integrated Next.js API routes for seamless backend communication.</li>
